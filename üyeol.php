							...
							<div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
								...
								<div class=" card-body p-4 p-sm-5">
									...
									<form action="" method="POST">
										...
										<hr>
										<div class="form-floating mb-3">
											<input type="text" class="form-control" name="telefonNo" placeholder="5070555555">
											<label for="floatingInputText">Telefon Numarası</label>
										</div>
										...
										<div class="d-grid mb-2">
											<button class="btn btn-lg btn-warning btn-login fw-bold text-uppercase" type="submit" name="kayitol">Kayıt Ol</button>
										</div>
