...
<body>
		...
		<div class="container">
			...
			<div class=" collapse navbar-collapse" id="navbarNavDropdown">
				...
				<ul class="navbar-nav ms-auto ">
					...
					<li class="nav-item">
						<a class="nav-link mx-2 text-uppercase " href="giyim.php">Giyim</a>
					</li>
					<li class="nav-item">
						<a class="nav-link mx-2 text-uppercase" href="ev.php">Ev</a>
					</li>
					<li class="nav-item">
						<a class="nav-link mx-2 text-uppercase active" href="kitap,müzik.php">Kitap,Müzik </a>
					</li>
				</ul>
				<ul class="navbar-nav ms-auto ">
					<li class="nav-item">
	...
	<div class="container">
		...
		<div class="row">
			...
			<?php
			$sorgu = $baglan->prepare("SELECT * FROM `kitap_muzik`");
			...
			foreach ($rows as $row) : ?>
				...
				<div class="col-6 col-md-3 p-2">
					...
					<div class="card">
						<img src="admin/image/<?php echo $row['img_url']; ?>" alt="">
						<div class="card-body">
							<h6 class="card-title"><?php echo $row['urun_ismi']; ?></h6>
							<p><?php echo $row['detay']; ?></p>
							<h4 class="card-body">
