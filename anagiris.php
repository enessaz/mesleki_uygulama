		...
		<div class="container">
			...
			<div class=" collapse navbar-collapse" id="navbarNavDropdown">
				...
				<ul class="navbar-nav ms-auto ">
					...
					<li class="nav-item">
						<a class="nav-link mx-2 text-uppercase active" href="anagiris.php"><i class="fa-solid fa-circle-user me-1"></i>
							Giriş</a>
					</li>
				</ul>
			</div>
            ...
            <div class="col-lg-10 col-xl-9 mx-auto">
              <div class="card flex-row my-5 border-0 shadow rounded-3 overflow-hidden">
                ...
                <div class="card-body p-4 p-sm-5">
                  <h5 class="card-title text-center mb-5 fw-light fs-5">Üye Girişi</h5>
                  <form action="" method="POST">
                    ...
                    <div class="d-grid mb-2">
                      <button class="btn btn-lg btn-primary btn-login fw-bold text-uppercase" type="submit" name="kayitol">Giriş Yap</button>
                    </div>
...
$eMail=@$_POST["eMail"];
$sifre=@$_POST["sifre"];
$user= $db->query("SELECT * FROM kullanicikayit WHERE email='$eMail' AND sifre='$sifre'")->fetch();
if ($user) {
	$_SESSION['user']=$user;
